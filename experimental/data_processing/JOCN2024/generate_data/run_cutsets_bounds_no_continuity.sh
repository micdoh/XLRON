...
OUTPUT_FILE="experiment_results_cutsets_bounds_no_continuity.jsonl"

# Fixed cutset flags
CUTSET_FLAGS="--CUTSET_EXHAUSTIVE --CUTSET_BATCH_SIZE=512 --CUTSET_ITERATIONS=32 --CUTSET_TOP_K=256 --cutset_link_selection_mode=least_congested --NEGLECT_SPECTRUM_CONTINUITY"
...
JPN48_CUTSET_FLAGS="--CUTSET_TOP_K=256 --cutset_link_selection_mode=least_congested --NEGLECT_SPECTRUM_CONTINUITY"
