...
run_experiment "DeepRMSA" "cost239_deeprmsa_directed" 400 630 10 "$k" "./cost239_deeprmsa_13.eqx" 8 "$args"

# USNET GCN-RMSA (usnet_gcnrnn_directed)
run_experiment "GCN-RMSA" "usnet_gcnrnn_directed" 310 510 10 "$k" "./usnet_2.eqx" 8 "$args"
...
run_experiment "MaskRSA" "nsfnet_deeprmsa_undirected" 90 145 5 "$k" "./nsfnet_maskrsa_43_1.eqx" 4 "$args"

# JPN48 MaskRSA (jpn48_undirected)
run_experiment "MaskRSA" "jpn48_undirected" 160 260 10 "$k" "./jpn48_maskrsa.eqx" 8 "$args"
...
run_experiment "PtrNet-RSA-40" "nsfnet_deeprmsa_undirected" 200 270 10 "$k" "./nsfnet_rsa40.eqx" 8 "$args"

# COST239 PtrNet-RSA-40
args="$base_args --link_resources 40 --values_bw 1"
run_experiment "PtrNet-RSA-40" "cost239_ptrnet_real_undirected" 420 500 10 "$k" "./cost239_rsa40.eqx" 8 "$args"

# USNET PtrNet-RSA-40
args="$base_args --link_resources 40 --values_bw 1"
run_experiment "PtrNet-RSA-40" "usnet_ptrnet_undirected" 210 310 10 "$k" "./usnet_rsa40.eqx" 8 "$args"
...
run_experiment "PtrNet-RSA-80" "nsfnet_deeprmsa_undirected" 210 340 10 "$k" "./nsfnet_rsa80.eqx" 8 "$args"

# COST239 PtrNet-RSA-80
args="$base_args --link_resources 80 --values_bw $var_bw"
run_experiment "PtrNet-RSA-80" "cost239_ptrnet_real_undirected" 450 670 10 "$k" "./cost239_rsa80_1.eqx" 8 "$args"

# USNET PtrNet-RSA-80
args="$base_args --link_resources 80 --values_bw $var_bw"
run_experiment "PtrNet-RSA-80" "usnet_ptrnet_undirected" 220 380 10 "$k" "./usnet_rsa80.eqx" 8 "$args"
