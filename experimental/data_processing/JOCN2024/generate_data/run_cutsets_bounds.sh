...
run_experiment "DeepRMSA~Reward-RMSA~GCN-RMSA" "cost239_deeprmsa_directed" "370" "390" "10" "50" "$args"
...
run_experiment "MaskRSA" "nsfnet_deeprmsa_undirected" "70" "75" "5" "50" "$args"
...
run_experiment "MaskRSA" "jpn48_undirected" "145" "145" "10" "50" "$args" "$JPN48_CUTSET_FLAGS"
...
run_experiment "PtrNet-RSA-40" "nsfnet_deeprmsa_undirected" "170" "190" "10" "50" "$args"
# COST239 PtrNet-RSA-40
args="$base_args --link_resources 40 --values_bw 1"
run_experiment "PtrNet-RSA-40" "cost239_ptrnet_real_undirected" "330" "410" "10" "50" "$args"
# USNET PtrNet-RSA-40
args="$base_args --link_resources 40 --values_bw 1"
...
run_experiment "PtrNet-RSA-80" "nsfnet_deeprmsa_undirected" "200" "200" "10" "50" "$args"
# COST239 PtrNet-RSA-80
args="$base_args --link_resources 80 --values_bw $var_bw"
run_experiment "PtrNet-RSA-80" "cost239_ptrnet_real_undirected" "420" "440" "10" "50" "$args"
# USNET PtrNet-RSA-80
args="$base_args --link_resources 80 --values_bw $var_bw"
