def create_nobel_eu_graph():
    ...
    node_attributes = {
    1: {'lat': 52.2, 'long': 4.51, 'location': 'Sassenheim', 'country': 'Netherlands (Kingdom of the)'},
    ...
    12: {'lat': 55.51, 'long': -4.16, 'location': 'Muirkirk', 'country': 'United Kingdom of Great Britain and Northern Ireland (the)'},
    13: {'lat': 53.33, 'long': 10.0, 'location': 'Marxen', 'country': 'Germany'},
    14: {'lat': 51.3, 'long': -0.07, 'location': 'Whyteleafe', 'country': 'United Kingdom of Great Britain and Northern Ireland (the)'},
