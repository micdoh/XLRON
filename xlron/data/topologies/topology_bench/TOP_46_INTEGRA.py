def create_integra_graph():
    ...
    node_attributes = {
    1: {'lat': 41.85, 'long': -87.65, 'location': 'Chicago', 'country': 'United States of America (the)'},
    2: {'lat': 32.78, 'long': -96.81, 'location': 'Dallas', 'country': 'United States of America (the)'},
    3: {'lat': 45.56, 'long': -94.16, 'location': 'Saint Cloud', 'country': 'United States of America (the)'},
    4: {'lat': 44.98, 'long': -93.26, 'location': 'Minneapolis', 'country': 'United States of America (the)'},
    5: {'lat': 34.05, 'long': -118.24, 'location': 'Los Angeles', 'country': 'United States of America (the)'},
    6: {'lat': 37.35, 'long': -121.96, 'location': 'Santa Clara', 'country': 'United States of America (the)'},
    7: {'lat': 36.17, 'long': -115.14, 'location': 'Las Vegas', 'country': 'United States of America (the)'},
    8: {'lat': 33.45, 'long': -112.07, 'location': 'Phoenix', 'country': 'United States of America (the)'},
    9: {'lat': 38.58, 'long': -121.49, 'location': 'Sacramento', 'country': 'United States of America (the)'},
    10: {'lat': 38.44, 'long': -122.71, 'location': 'Santa Rosa', 'country': 'United States of America (the)'},
    11: {'lat': 44.94, 'long': -123.04, 'location': 'Salem', 'country': 'United States of America (the)'},
    12: {'lat': 44.06, 'long': -121.32, 'location': 'Bend', 'country': 'United States of America (the)'},
    13: {'lat': 44.05, 'long': -123.09, 'location': 'Eugene', 'country': 'United States of America (the)'},
    14: {'lat': 39.53, 'long': -119.81, 'location': 'Reno', 'country': 'United States of America (the)'},
    15: {'lat': 38.59, 'long': -121.3, 'location': 'Rancho Cordova', 'country': 'United States of America (the)'},
    16: {'lat': 40.71, 'long': -74.01, 'location': 'New York City', 'country': 'United States of America (the)'},
    17: {'lat': 39.04, 'long': -77.49, 'location': 'Ashburn', 'country': 'United States of America (the)'},
    18: {'lat': 47.66, 'long': -117.43, 'location': 'Spokane', 'country': 'United States of America (the)'},
    19: {'lat': 46.88, 'long': -96.79, 'location': 'Fargo', 'country': 'United States of America (the)'},
    20: {'lat': 45.78, 'long': -108.5, 'location': 'Billings', 'country': 'United States of America (the)'},
    21: {'lat': 39.74, 'long': -104.98, 'location': 'Denver', 'country': 'United States of America (the)'},
    22: {'lat': 41.22, 'long': -111.97, 'location': 'Ogden', 'country': 'United States of America (the)'},
    23: {'lat': 40.3, 'long': -111.69, 'location': 'Orem', 'country': 'United States of America (the)'},
    24: {'lat': 40.76, 'long': -111.89, 'location': 'Salt Lake City', 'country': 'United States of America (the)'},
    25: {'lat': 43.61, 'long': -116.2, 'location': 'Boise', 'country': 'United States of America (the)'},
    26: {'lat': 45.52, 'long': -122.68, 'location': 'Portland', 'country': 'United States of America (the)'},
    27: {'lat': 47.61, 'long': -122.33, 'location': 'Seattle', 'country': 'United States of America (the)'},
    }
