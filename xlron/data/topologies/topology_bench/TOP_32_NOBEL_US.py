def create_nobel_us_graph():
    ...
    node_attributes = {
    1: {'lat': 37.25, 'long': -122.07, 'location': 'Saratoga', 'country': 'United States of America (the)'},
    2: {'lat': 32.42, 'long': -117.08, 'location': 'Quinta del Cedro', 'country': 'Mexico'},
    3: {'lat': 40.0, 'long': -105.16, 'location': 'Louisville', 'country': 'United States of America (the)'},
    4: {'lat': 38.52, 'long': -77.02, 'location': 'La Plata', 'country': 'United States of America (the)'},
    5: {'lat': 33.44, 'long': -84.23, 'location': 'Hampton', 'country': 'United States of America (the)'},
    6: {'lat': 40.06, 'long': -88.14, 'location': 'Philo', 'country': 'United States of America (the)'},
    7: {'lat': 42.16, 'long': -83.43, 'location': 'Romulus', 'country': 'United States of America (the)'},
    8: {'lat': 40.47, 'long': -96.42, 'location': 'Tecumseh', 'country': 'United States of America (the)'},
    9: {'lat': 40.21, 'long': -74.39, 'location': 'Vista Center', 'country': 'United States of America (the)'},
    10: {'lat': 42.26, 'long': -76.3, 'location': 'Owego', 'country': 'United States of America (the)'},
    11: {'lat': 40.26, 'long': -79.58, 'location': 'Youngwood', 'country': 'United States of America (the)'},
    12: {'lat': 29.45, 'long': -95.21, 'location': 'Alvin', 'country': 'United States of America (the)'},
    13: {'lat': 40.39, 'long': -111.55, 'location': 'Midway', 'country': 'United States of America (the)'},
    14: {'lat': 47.33, 'long': -122.24, 'location': 'Auburn', 'country': 'United States of America (the)'},
    }
