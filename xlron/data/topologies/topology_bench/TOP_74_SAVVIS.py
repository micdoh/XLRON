def create_savvis_graph():
    ...
    node_attributes = {
    1: {'lat': 40.71, 'long': -74.01, 'location': 'New York City', 'country': 'United States of America (the)'},
    ...
    5: {'lat': 29.76, 'long': -95.36, 'location': 'Houston', 'country': 'United States of America (the)'},
    ...
    10: {'lat': 40.12, 'long': -88.24, 'location': 'Champaign', 'country': 'United States of America (the)'},
    11: {'lat': 41.85, 'long': -87.65, 'location': 'Chicago', 'country': 'United States of America (the)'},
    ...
    14: {'lat': 32.72, 'long': -117.16, 'location': 'San Diego', 'country': 'United States of America (the)'},
    15: {'lat': 33.45, 'long': -112.07, 'location': 'Phoenix', 'country': 'United States of America (the)'},
    16: {'lat': 40.76, 'long': -111.89, 'location': 'Salt Lake City', 'country': 'United States of America (the)'},
    17: {'lat': 39.74, 'long': -104.98, 'location': 'Denver', 'country': 'United States of America (the)'},
    18: {'lat': 39.11, 'long': -94.63, 'location': 'Kansas City', 'country': 'United States of America (the)'},
    19: {'lat': 38.63, 'long': -90.2, 'location': 'St. Louis', 'country': 'United States of America (the)'},
    }
