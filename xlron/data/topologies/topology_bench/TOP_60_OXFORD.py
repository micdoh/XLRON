def create_oxford_graph():
    ...
    node_attributes = {
    1: {'lat': 43.07, 'long': -70.76, 'location': 'Portsmouth', 'country': 'United States of America (the)'},
    2: {'lat': 43.2, 'long': -70.87, 'location': 'Dover', 'country': 'United States of America (the)'},
    3: {'lat': 43.49, 'long': -70.45, 'location': 'Biddeford', 'country': 'United States of America (the)'},
    4: {'lat': 43.44, 'long': -70.77, 'location': 'Sanford (historical)', 'country': 'United States of America (the)'},
    5: {'lat': 42.36, 'long': -71.06, 'location': 'Boston', 'country': 'United States of America (the)'},
    6: {'lat': 42.28, 'long': -71.42, 'location': 'Framingham', 'country': 'United States of America (the)'},
    7: {'lat': 43.0, 'long': -71.45, 'location': 'Manchester', 'country': 'United States of America (the)'},
    8: {'lat': 42.93, 'long': -72.28, 'location': 'Keene', 'country': 'United States of America (the)'},
    9: {'lat': 42.26, 'long': -71.8, 'location': 'Worcester', 'country': 'United States of America (the)'},
    10: {'lat': 42.1, 'long': -72.59, 'location': 'Springfield', 'country': 'United States of America (the)'},
    11: {'lat': 44.8, 'long': -68.78, 'location': 'Bangor', 'country': 'United States of America (the)'},
    12: {'lat': 43.66, 'long': -70.26, 'location': 'Portland', 'country': 'United States of America (the)'},
    13: {'lat': 44.26, 'long': -70.26, 'location': 'Turner', 'country': 'United States of America (the)'},
    14: {'lat': 44.4, 'long': -70.79, 'location': 'Bethel', 'country': 'United States of America (the)'},
    15: {'lat': 44.21, 'long': -70.54, 'location': 'Norway', 'country': 'United States of America (the)'},
    16: {'lat': 43.74, 'long': -70.55, 'location': 'Buxton', 'country': 'United States of America (the)'},
    17: {'lat': 44.29, 'long': -70.37, 'location': 'Buckfield', 'country': 'United States of America (the)'},
    18: {'lat': 44.31, 'long': -69.78, 'location': 'Augusta', 'country': 'United States of America (the)'},
    19: {'lat': 44.1, 'long': -70.21, 'location': 'Lewiston', 'country': 'United States of America (the)'},
    }
