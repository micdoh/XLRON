def create_hibernia_us_graph():
    ...
    node_attributes = {
    1: {'lat': 40.44, 'long': -80.0, 'location': 'Pittsburgh', 'country': 'United States of America (the)'},
    2: {'lat': 39.95, 'long': -75.16, 'location': 'Philadelphia', 'country': 'United States of America (the)'},
    3: {'lat': 40.74, 'long': -74.17, 'location': 'Newark', 'country': 'United States of America (the)'},
    4: {'lat': 39.04, 'long': -77.49, 'location': 'Ashburn', 'country': 'United States of America (the)'},
    5: {'lat': 35.77, 'long': -78.64, 'location': 'Raleigh', 'country': 'United States of America (the)'},
    6: {'lat': 35.23, 'long': -80.84, 'location': 'Charlotte', 'country': 'United States of America (the)'},
    7: {'lat': 38.93, 'long': -77.18, 'location': 'McLean', 'country': 'United States of America (the)'},
    8: {'lat': 37.55, 'long': -77.46, 'location': 'Richmond', 'country': 'United States of America (the)'},
    9: {'lat': 33.75, 'long': -84.39, 'location': 'Atlanta', 'country': 'United States of America (the)'},
    10: {'lat': 40.71, 'long': -74.01, 'location': 'New York City', 'country': 'United States of America (the)'},
    11: {'lat': 41.03, 'long': -73.76, 'location': 'White Plains', 'country': 'United States of America (the)'},
    12: {'lat': 41.05, 'long': -73.54, 'location': 'Stamford', 'country': 'United States of America (the)'},
    13: {'lat': 41.85, 'long': -87.65, 'location': 'Chicago', 'country': 'United States of America (the)'},
    14: {'lat': 41.5, 'long': -81.7, 'location': 'Cleveland', 'country': 'United States of America (the)'},
    15: {'lat': 42.89, 'long': -78.88, 'location': 'Buffalo', 'country': 'United States of America (the)'},
    16: {'lat': 43.7, 'long': -79.42, 'location': 'Toronto', 'country': 'Canada'},
    17: {'lat': 45.51, 'long': -73.59, 'location': 'Montreal', 'country': 'Canada'},
    18: {'lat': 42.65, 'long': -73.76, 'location': 'Albany', 'country': 'United States of America (the)'},
    19: {'lat': 42.36, 'long': -71.06, 'location': 'Boston', 'country': 'United States of America (the)'},
