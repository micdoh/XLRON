def create_digex_graph():
    ...
    2: {'lat': 41.26, 'long': -95.94, 'location': 'Omaha', 'country': 'United States of America (the)'},
    3: {'lat': 39.96, 'long': -83.0, 'location': 'Columbus', 'country': 'United States of America (the)'},
    4: {'lat': 42.33, 'long': -83.05, 'location': 'Detroit', 'country': 'United States of America (the)'},
    5: {'lat': 33.75, 'long': -84.39, 'location': 'Atlanta', 'country': 'United States of America (the)'},
    6: {'lat': 30.33, 'long': -81.66, 'location': 'Jacksonville', 'country': 'United States of America (the)'},
    7: {'lat': 39.11, 'long': -94.63, 'location': 'Kansas City', 'country': 'United States of America (the)'},
    8: {'lat': 38.63, 'long': -90.2, 'location': 'St. Louis', 'country': 'United States of America (the)'},
    9: {'lat': 28.54, 'long': -81.38, 'location': 'Orlando', 'country': 'United States of America (the)'},
    10: {'lat': 27.95, 'long': -82.46, 'location': 'Tampa', 'country': 'United States of America (the)'},
    11: {'lat': 39.29, 'long': -76.61, 'location': 'Baltimore', 'country': 'United States of America (the)'},
    12: {'lat': 39.95, 'long': -75.16, 'location': 'Philadelphia', 'country': 'United States of America (the)'},
    13: {'lat': 40.22, 'long': -74.74, 'location': 'Trenton', 'country': 'United States of America (the)'},
    14: {'lat': 40.44, 'long': -80.0, 'location': 'Pittsburgh', 'country': 'United States of America (the)'},
    15: {'lat': 37.55, 'long': -77.46, 'location': 'Richmond', 'country': 'United States of America (the)'},
    16: {'lat': 35.23, 'long': -80.84, 'location': 'Charlotte', 'country': 'United States of America (the)'},
    17: {'lat': 25.77, 'long': -80.19, 'location': 'Miami', 'country': 'United States of America (the)'},
    18: {'lat': 40.74, 'long': -74.17, 'location': 'Newark', 'country': 'United States of America (the)'},
    19: {'lat': 40.71, 'long': -74.01, 'location': 'New York City', 'country': 'United States of America (the)'},
    20: {'lat': 38.9, 'long': -77.04, 'location': 'Washington, D.C.', 'country': 'United States of America (the)'},
    21: {'lat': 42.36, 'long': -71.06, 'location': 'Boston', 'country': 'United States of America (the)'},
    22: {'lat': 38.25, 'long': -85.76, 'location': 'Louisville', 'country': 'United States of America (the)'},
    23: {'lat': 39.16, 'long': -84.46, 'location': 'Cincinnati', 'country': 'United States of America (the)'},
    24: {'lat': 37.67, 'long': -122.08, 'location': 'Hayward', 'country': 'United States of America (the)'},
    25: {'lat': 34.05, 'long': -118.24, 'location': 'Los Angeles', 'country': 'United States of America (the)'},
    26: {'lat': 32.78, 'long': -96.81, 'location': 'Dallas', 'country': 'United States of America (the)'},
    27: {'lat': 32.73, 'long': -97.32, 'location': 'Fort Worth', 'country': 'United States of America (the)'},
    28: {'lat': 30.27, 'long': -97.74, 'location': 'Austin', 'country': 'United States of America (the)'},
    29: {'lat': 37.77, 'long': -122.42, 'location': 'San Francisco', 'country': 'United States of America (the)'},
    30: {'lat': 29.76, 'long': -95.36, 'location': 'Houston', 'country': 'United States of America (the)'},
    31: {'lat': 36.17, 'long': -86.78, 'location': 'Nashville', 'country': 'United States of America (the)'},
    }
