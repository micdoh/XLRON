def create_atmnet_graph():
    ...
    node_attributes = {
    1: {'lat': 40.76, 'long': -111.89, 'location': 'Salt Lake City', 'country': 'United States of America (the)'},
    2: {'lat': 44.98, 'long': -93.26, 'location': 'Minneapolis', 'country': 'United States of America (the)'},
    3: {'lat': 39.11, 'long': -94.63, 'location': 'Kansas City', 'country': 'United States of America (the)'},
    4: {'lat': 39.74, 'long': -104.98, 'location': 'Denver', 'country': 'United States of America (the)'},
    5: {'lat': 40.44, 'long': -80.0, 'location': 'Pittsburgh', 'country': 'United States of America (the)'},
    6: {'lat': 39.95, 'long': -75.16, 'location': 'Philadelphia', 'country': 'United States of America (the)'},
    7: {'lat': 41.85, 'long': -87.65, 'location': 'Chicago', 'country': 'United States of America (the)'},
    8: {'lat': 42.33, 'long': -83.05, 'location': 'Detroit', 'country': 'United States of America (the)'},
    9: {'lat': 40.71, 'long': -74.01, 'location': 'New York City', 'country': 'United States of America (the)'},
    10: {'lat': 38.9, 'long': -77.04, 'location': 'Washington, D.C.', 'country': 'United States of America (the)'},
    ...
    13: {'lat': 38.63, 'long': -90.2, 'location': 'St. Louis', 'country': 'United States of America (the)'},
    14: {'lat': 47.61, 'long': -122.33, 'location': 'Seattle', 'country': 'United States of America (the)'},
    15: {'lat': 37.8, 'long': -122.27, 'location': 'Oakland', 'country': 'United States of America (the)'},
    16: {'lat': 37.35, 'long': -121.96, 'location': 'Santa Clara', 'country': 'United States of America (the)'},
    17: {'lat': 33.75, 'long': -84.39, 'location': 'Atlanta', 'country': 'United States of America (the)'},
    18: {'lat': 32.72, 'long': -117.16, 'location': 'San Diego', 'country': 'United States of America (the)'},
    19: {'lat': 33.45, 'long': -112.07, 'location': 'Phoenix', 'country': 'United States of America (the)'},
    20: {'lat': 32.22, 'long': -110.93, 'location': 'Tucson', 'country': 'United States of America (the)'},
    21: {'lat': 32.78, 'long': -96.81, 'location': 'Dallas', 'country': 'United States of America (the)'},
    }
