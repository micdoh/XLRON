def create_noel_graph():
    ...
    node_attributes = {
    1: {'lat': 47.66, 'long': -117.43, 'location': 'Spokane', 'country': 'United States of America (the)'},
    2: {'lat': 47.68, 'long': -116.78, 'location': "Coeur d'Alene", 'country': 'United States of America (the)'},
    3: {'lat': 47.42, 'long': -120.31, 'location': 'Wenatchee', 'country': 'United States of America (the)'},
    4: {'lat': 46.83, 'long': -119.18, 'location': 'Othello', 'country': 'United States of America (the)'},
    5: {'lat': 46.06, 'long': -118.34, 'location': 'Walla Walla', 'country': 'United States of America (the)'},
    6: {'lat': 46.24, 'long': -119.1, 'location': 'Pasco', 'country': 'United States of America (the)'},
    7: {'lat': 46.73, 'long': -117.18, 'location': 'Pullman', 'country': 'United States of America (the)'},
    8: {'lat': 46.42, 'long': -117.02, 'location': 'Lewiston', 'country': 'United States of America (the)'},
    9: {'lat': 46.21, 'long': -119.14, 'location': 'Kennewick', 'country': 'United States of America (the)'},
    10: {'lat': 46.6, 'long': -120.51, 'location': 'Yakima', 'country': 'United States of America (the)'},
    11: {'lat': 47.0, 'long': -120.55, 'location': 'Ellensburg', 'country': 'United States of America (the)'},
    12: {'lat': 49.25, 'long': -123.12, 'location': 'Vancouver', 'country': 'Canada'},
    13: {'lat': 48.76, 'long': -122.49, 'location': 'Bellingham', 'country': 'United States of America (the)'},
    14: {'lat': 48.42, 'long': -122.33, 'location': 'Mount Vernon', 'country': 'United States of America (the)'},
    15: {'lat': 47.98, 'long': -122.2, 'location': 'Everett', 'country': 'United States of America (the)'},
    16: {'lat': 47.61, 'long': -122.34, 'location': 'Seattle', 'country': 'United States of America (the)'},
    17: {'lat': 47.25, 'long': -122.44, 'location': 'Tacoma', 'country': 'United States of America (the)'},
    18: {'lat': 47.04, 'long': -122.9, 'location': 'Olympia', 'country': 'United States of America (the)'},
    19: {'lat': 45.52, 'long': -122.68, 'location': 'Portland', 'country': 'United States of America (the)'},
    }
