def create_crl_network_services_graph():
    ...
    node_attributes = {
    1: {'lat': 33.45, 'long': -112.07, 'location': 'Phoenix', 'country': 'United States of America (the)'},
    2: {'lat': 35.08, 'long': -106.65, 'location': 'Albuquerque', 'country': 'United States of America (the)'},
    3: {'lat': 33.84, 'long': -117.91, 'location': 'Anaheim', 'country': 'United States of America (the)'},
    4: {'lat': 32.72, 'long': -117.16, 'location': 'San Diego', 'country': 'United States of America (the)'},
    5: {'lat': 29.42, 'long': -98.49, 'location': 'San Antonio', 'country': 'United States of America (the)'},
    6: {'lat': 29.76, 'long': -95.36, 'location': 'Houston', 'country': 'United States of America (the)'},
    7: {'lat': 32.78, 'long': -96.81, 'location': 'Dallas', 'country': 'United States of America (the)'},
    8: {'lat': 30.27, 'long': -97.74, 'location': 'Austin', 'country': 'United States of America (the)'},
    ...
    11: {'lat': 39.11, 'long': -94.63, 'location': 'Kansas City', 'country': 'United States of America (the)'},
    12: {'lat': 39.74, 'long': -104.98, 'location': 'Denver', 'country': 'United States of America (the)'},
    13: {'lat': 27.95, 'long': -82.46, 'location': 'Tampa', 'country': 'United States of America (the)'},
    14: {'lat': 38.63, 'long': -90.2, 'location': 'St. Louis', 'country': 'United States of America (the)'},
    15: {'lat': 40.44, 'long': -80.0, 'location': 'Pittsburgh', 'country': 'United States of America (the)'},
    16: {'lat': 40.71, 'long': -74.01, 'location': 'New York City', 'country': 'United States of America (the)'},
    17: {'lat': 39.95, 'long': -75.16, 'location': 'Philadelphia', 'country': 'United States of America (the)'},
    18: {'lat': 39.29, 'long': -76.61, 'location': 'Baltimore', 'country': 'United States of America (the)'},
    19: {'lat': 38.9, 'long': -77.04, 'location': 'Washington, D.C.', 'country': 'United States of America (the)'},
    20: {'lat': 41.85, 'long': -87.65, 'location': 'Chicago', 'country': 'United States of America (the)'},
    21: {'lat': 42.33, 'long': -83.05, 'location': 'Detroit', 'country': 'United States of America (the)'},
    22: {'lat': 41.5, 'long': -81.7, 'location': 'Cleveland', 'country': 'United States of America (the)'},
    23: {'lat': 42.36, 'long': -71.06, 'location': 'Boston', 'country': 'United States of America (the)'},
    ...
    26: {'lat': 47.61, 'long': -122.33, 'location': 'Seattle', 'country': 'United States of America (the)'},
    27: {'lat': 45.52, 'long': -122.68, 'location': 'Portland', 'country': 'United States of America (the)'},
    28: {'lat': 38.44, 'long': -122.71, 'location': 'Santa Rosa', 'country': 'United States of America (the)'},
    29: {'lat': 38.58, 'long': -121.49, 'location': 'Sacramento', 'country': 'United States of America (the)'},
    30: {'lat': 37.96, 'long': -121.29, 'location': 'Stockton', 'country': 'United States of America (the)'},
    31: {'lat': 43.21, 'long': -71.54, 'location': 'Concord', 'country': 'United States of America (the)'},
    32: {'lat': 37.97, 'long': -122.53, 'location': 'San Rafael', 'country': 'United States of America (the)'},
    33: {'lat': 37.77, 'long': -122.42, 'location': 'San Francisco', 'country': 'United States of America (the)'},
    }
