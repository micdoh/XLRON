...
flags.DEFINE_integer("DOWNSAMPLE_FACTOR", 1, "Downsample factor for uploading video to wandb")
...
flags.DEFINE_boolean("uniform_traffic", True, "Uniform traffic matrix for RSA (else random)")
