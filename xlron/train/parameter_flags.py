...
flags.DEFINE_integer("load", 250, "Load")
flags.DEFINE_integer("mean_service_holding_time", 25, "Mean service holding time")
...
flags.DEFINE_string("modulations_csv_filepath", None, "")
