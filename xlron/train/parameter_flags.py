...
flags.DEFINE_boolean("use_gn_model", False, "Use GN model for link SNR estimation")
flags.DEFINE_boolean("include_isrs", False, "Include ISRS in the GN model or just ASE noise")
flags.DEFINE_boolean("mod_format_correction", False, "Apply modulation format correction")
flags.DEFINE_float("ref_lambda", 1550e-9, "Reference wavelength [m]")
flags.DEFINE_float("span_length", 100e3, "Span length [m]")
flags.DEFINE_float("launch_power", 0, "Launch power [dBm]")
