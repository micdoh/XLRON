...
flags.DEFINE_string("modulations_csv_filepath", "./modulations/modulations.csv", "Modulation format definitions for RSA environment")
...
flags.DEFINE_integer("output_nodes_size", 0, "Output nodes size")
flags.DEFINE_integer("output_globals_size", 1, "Output globals size")
