...
Requirements are defined in pyproject.toml and can be installed with [uv](https://docs.astral.sh/uv/) via `uv sync`. See [quickstart](quickstart.md) for more details.
